              ...
              {deck.map((card) => {
                ...
                return (
                  <button
                    ...
                    className={
                      'flex items-center justify-center rounded-2xl transition-all duration-300 ease-bounce-soft ' +
                      (faceUp
                        ? isMatched
                          ? 'border-2 border-green-300 bg-green-50'
                          : 'border-2 border-brand-300 bg-white'
                        : 'bg-brand-400 hover:bg-brand-500 hover:-translate-y-0.5 hover:shadow-float active:scale-[0.97] cursor-pointer shadow-card')
                    }
